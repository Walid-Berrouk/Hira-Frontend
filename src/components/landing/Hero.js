...
export default function Hero() {
  return (
    <div className='h-screen text-white flex flex-col items-center justify-center'>
        <h1 className='md:text-5xl text-3xl capitalize mt-20'>Welcome to <span className='font-bold'>Hira Assistant</span></h1>
        <h3 className='md:text-3xl text-xl capitalize mt-6'>Your personal hiring assistant </h3>
